        ...
        <div class="dialog-body">
            ...
            <div class="pnl-info pnl-weibo">
                ...
                <div class="content">
                    ...
                    <div class="content-body">文字某某文字某某<span class="color2">节点</span>文字某某文字某某文字某某文字某某<span
                            class="color2">节点节点</span>文字某某文字某某
                    </div>
                </div>
            </div>
            <div class="pnl-info pnl-weixin">
                <div class="head">
                    ...
                    <ul class="head-right fr">
                        <li class="all"><a href="javascript:;">查看全部</a></li>
                        <li class="view" style="background-image: url(img/path-down.png);"><a href="javascript:;">预览</a>
                        </li>
                    </ul>
                </div>
                <div class="content" style="display:none;">
                    ...
                    <div class="content-body">文字某某文字某某<span class="color3">节点</span>文字某某文字某某文字某某文字某某<span
                            class="color3">节点节点</span>文字某某文字某某
                    </div>
                </div>
            </div>
        </div>
