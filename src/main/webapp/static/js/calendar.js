...
(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<a href="javascript:;" data-calendar-display-date class="calendar-display" style="font-size:30px;color:#fff;">',
            '{yyyy}/<span class="m">{mm}</span>',
            '</a>',
            '<div class="calendar-arrow calendar-arrow-left">',
            '<span class="prev" title="上一月" data-calendar-arrow-date style="background-image:url(img/prev-arrow.png);"></span>',
            '</div>',
            '<div class="calendar-arrow calendar-arrow-right">',
            '<span class="next" title="下一月" data-calendar-arrow-date style="background-image:url(img/next-arrow.png);"></span>',
            '</div>',
            '</div>',
            '<div class="calendar-ct">',
            '<ol class="week" style="font-size:14px;color:#4a4a4a;background:#202020;margin-bottom:20px;margin-left:18px;">{week}</ol>',
    ...
    Calendar.prototype = {
        ...
        setMonthAction: function(y) {
            ...
            if (y === this.date.getFullYear()) {
                this.$monthItems.children().eq(m - 1).find("a").addClass(TODAY_CLASS);
            }
        },
        fillStatic: function() {
            var staticData = {
...
//            });
            ...
            _this.$element.on('mouseenter', '[' + ITEM_DAY + ']', function(e) {
                var arr = _this.getDisDateValue(),
                    day = new Date(arr[0], arr[1] - 1, parseInt(this.innerText));
