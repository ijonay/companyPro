...
public class AllPaths {
    ...
    public List<PathModel> getAllPath(String start, float[] targetVector) {
    ...
    private float getSimilarity(String start, String target) {
        float[] startVector = this.wordMap.get(start);
        float[] tVector = this.wordMap.get(target);
    ...
    public static void main(String[] args) {
        ...
        List<PathModel> allPaths = paths.getAllPath("霍建华", targetVector);
        allPaths.forEach(p -> {
